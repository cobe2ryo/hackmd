...
ことから、全種Jsontype47/action9と確定していたが、支給されたエクセルでは、個別に音声ファイルを送信する指示となっており再度調整が必要。
- [ ]  屋外拡声器
支給エクセルによると、屋外拡声器にモーターサイレン音をプリセットする案は却下され、それぞれ音声ファイルを送信することとなっている。再度調整が必要。識別子があれば、NESさんで対応可能か？
- [ ]  モーターサイレン
支給エクセルの「起動」がreproductionMediaは「1」であるか確認が必要
- [ ] キャンセル報
支給エクセルで調整。
...
### 20210427 屋外拡声器プレイセット音声

（1）只今屋外スピーカーのテスト放送中です　*2回（22秒）  
（2）上りチャイム（4秒）  
（3）下りチャイム（4秒）  
（4）ピー音　*2回（1分12秒）  
（5）ピー音　*2回（1分13秒）  
